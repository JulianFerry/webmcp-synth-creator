...
import { parsePatchState } from './schemas'
...
export function createDefaultPatch(): PatchState {
  return parsePatchState({
    ...
    metadata: {
      name: 'Ethereal Gate',
      category: 'pad',
      description: 'An airy generated wavetable pad prepared for conservative tonal editing.',
      tags: ['airy', 'wide', 'rhythmic'],
    },
    oscillators: [
      {
        enabled: true,
    ...
    wavetableData: createWavetableData(['airy', 'sine', 'triangle']),
  })
}
