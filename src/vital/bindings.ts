...
export const VITAL_SCALAR_BINDINGS: Record<VitalScalarPath, VitalScalarBinding> = {
  ...
  'filter.keytrack': bind('filter.keytrack', 'filter_fx_keytrack'),
  ...
  'effects.chorus.feedback': bind('effects.chorus.feedback', 'chorus_feedback', affine(0.95)),
...
export const FORCED_VITAL_BINDINGS = [
  ...
  { key: 'chorus_sync', value: 0, ownership: 'forced', justification: 'The workbench models a free-running chorus rate.' },
  { key: 'chorus_cutoff', value: 60, ownership: 'forced', justification: 'Keeps the unmodeled chorus filter cutoff at Vital default.' },
  { key: 'chorus_spread', value: 1, ownership: 'forced', justification: 'Keeps the unmodeled chorus filter spread at Vital default.' },
  { key: 'chorus_delay_1', value: -9, ownership: 'forced', justification: 'Keeps the unmodeled first chorus delay at Vital default.' },
  { key: 'chorus_delay_2', value: -7, ownership: 'forced', justification: 'Keeps the unmodeled second chorus delay at Vital default.' },
