...
> = {
  ...
  'oscillators.2.pan': ACTIVE,
  'ampEnvelope.delaySeconds': {
    scope: 'draft-only',
    semantics: 'Updates the draft envelope graph during the gesture; the committed delay starts with the next note.',
  },
  ...
  'ampEnvelope.attackCurve': ACTIVE,
  'ampEnvelope.decayCurve': ACTIVE,
  'ampEnvelope.releaseCurve': ACTIVE,
  ...
  'voice.transposeSemitones': ACTIVE,
  'effects.distortion.drive': ACTIVE,
  'effects.distortion.mix': ACTIVE,
  'effects.chorus.voices': ACTIVE,
  'effects.chorus.rate': ACTIVE,
  'effects.chorus.depth': ACTIVE,
  'effects.chorus.feedback': ACTIVE,
  'effects.chorus.mix': ACTIVE,
  'effects.delay.timeSeconds': ACTIVE,
  'effects.delay.feedback': ACTIVE,
  'effects.delay.mix': ACTIVE,
  'effects.reverb.mix': ACTIVE,
  'effects.reverb.decaySeconds': ACTIVE,
  'effects.reverb.size': ACTIVE,
  'effects.reverb.predelay': ACTIVE,
  'effects.reverb.lowCut': ACTIVE,
  'effects.reverb.highCut': ACTIVE,
}
